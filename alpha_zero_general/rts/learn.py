...
This configuration needs to be kept seperate, as different neural_network and game configs are set
"""
...
if __name__ == "__main__":
    ...
    # create neural_network for this game
    g = Game()
    ...
    # Create coach instance that starts teaching neural_network on newly created game using self-play
