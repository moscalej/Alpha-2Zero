...
class OneStepLookaheadConnect4Player():
    ...
    def play(self, board):
        ...
        for move, valid in enumerate(valid_moves):
            ...
            if self.player_num == self.game.get_game_ended(*self.game.get_next_state(board, self.player_num, move)):
        ...
        if len(win_move_set) > 0:
            ...
            raise Exception('No valid moves remaining: %s' % game.string_representation(board))
